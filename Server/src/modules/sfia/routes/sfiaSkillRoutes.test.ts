...
import * as getSkillDetailController from "@SFIA/controllers/getSkillDetailController";
...
function normalize(obj: any): any {
  if (typeof obj === "string") {
    // Only normalize excessive whitespace, but preserve intentional line breaks
...
vi.mock("@SFIA/controllers/getSkillDetailController", () => ({
      ...
      const mockSkillDetails = {
        ...
        data: {
          competency: {
            ...
            note: `Activities may include, but are not limited to:
...
Depending on requirements and the characteristics of the project or assigned work, software development methods and lifecycles can be predictive (plan-`,
            overall:
      ...
      expect(response.body).toEqual(normalize(mockSkillDetails));
