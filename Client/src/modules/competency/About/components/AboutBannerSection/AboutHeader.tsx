const AboutHeader = ({ isVisible }: { isVisible: boolean }) => (
  <div className={`text-center mb-16 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
    <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-teal-600 to-teal-800 bg-clip-text text-transparent mb-6 tracking-tight">เกี่ยวกับพวกเรา</h1>
