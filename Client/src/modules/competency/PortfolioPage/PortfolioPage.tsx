    ...
    <PortfolioLayout>
      <div className="space-y-4 sm:space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 sm:mt-4">
        ...
        <div className="w-full">
          <PortfolioHeader userEmail={portfolioData?.userEmail || user?.email || ""} isDataStale={isDataStale} loading={loading} onRefresh={handleRefresh} lastUpdated={lastFetched || undefined} />
        </div>
