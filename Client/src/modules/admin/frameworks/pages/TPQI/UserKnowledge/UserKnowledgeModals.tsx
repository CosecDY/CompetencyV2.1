...
import { KnowledgeApprovalStatus } from "modules/admin/frameworks/types/tpqi/userKnowledgeTypes";
...
const STATUS_META: Record<KnowledgeApprovalStatus, { label: string; desc: string; badgeClass: string; cardRing: string }> = {
...
export const EditUserKnowledgeStatusModal: React.FC<EditUserKnowledgeStatusModalProps> = ({ isOpen, initialStatus, onClose, onConfirm, isLoading = false }) => {
